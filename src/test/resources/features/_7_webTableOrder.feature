Feature: Web table order feature
  ...
  Scenario: User should be able to place order and oder seen in the web table
  ...
  Scenario Outline: User should be able to place order and oder seen in the web table
    Given user is already logged in and on order page
